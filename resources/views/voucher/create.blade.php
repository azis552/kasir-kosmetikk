        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('vouchers.store') }}" method="POST" class="shadow p-4 rounded-lg bg-white">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="discount_amount" id="discount_amount" value=" {{ old('discount_amount', 0) }}" placeholder="Rp" required>
                            </div>
                            <div class="col-md-3">
                                <label for="start_date" class="form-label">Tanggal Mulai</label>
                                <input type="date" class="form-control" value="{{ old('start_date', date('Y-m-d')) }}" name="start_date" id="start_date" required>
                            </div>
                            <div class="col-md-3">
                                <label for="end_date" class="form-label">Tanggal Selesai</label>
                                <input type="date" class="form-control" name="end_date" value="{{ old('end_date', \Carbon\Carbon::now()->addDays(1)->format('Y-m-d')) }}" id="end_date" required>
                            </div>
                            <div class="col-md-3">
                                <label for="max_uses" class="form-label">Maksimal Penggunaan</label>
                                <input type="text" class="form-control" name="max_uses" id="max_uses" value="{{ old('max_uses', 0) }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
