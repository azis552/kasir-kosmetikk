        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('taxes.store') }}" method="POST" class="shadow p-4 rounded-lg bg-white">
                        @csrf
                        <h4 class="mb-4">Tambah Pajak</h4>
                        <div class="row mb-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="percentage" id="percentage" value="{{ old('percentage') }}" required>
                            </div>
                            <div class="col-md-4">
