    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Role: <strong>{{ $role->name }}</strong></h5>
                ...
                <form action="{{ route('roles.update', $role) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control"
                               ...
                               {{ in_array($role->name, ['admin','kasir']) ? 'readonly' : '' }}
                               required>
                        @if(in_array($role->name, ['admin','kasir']))
                            <small class="text-muted">Nama role sistem tidak bisa diubah.</small>
                        @endif
                    </div>
